...
void free_ast_node(ASTNode *node) {
    ...
    case NODE_TYPE_EXPRESSION:
        ...
        case EXPRESSION_FUNCTION_CALL:
            ...
            for (int i = 0;
                 i < node->node_expression.function_call_expr.arg_count; ++i) {
                free_ast_node(
                    node->node_expression.function_call_expr.arguments[i]);
            }
...
void print_ast_node(ASTNode *node, int indent) {
    ...
    case NODE_TYPE_STATEMENT:
        ...
        case STATEMENT_IF:
            ...
            print_ast_node(node->node_statement.if_stmt.then_branch,
                           indent + 1);
            // print_ast_node(node->node_statement.if_stmt.else_branch, indent +
            // 1);
            break;

        case STATEMENT_WHILE:
            printf("While Statement\n");
            print_ast_node(node->node_statement.while_stmt.condition,
                           indent + 1);
        ...
        case STATEMENT_EXPRESSION:
            ...
            print_ast_node(node->node_statement.expression_stmt.expression,
                           indent + 1);
            break;
        }
        break;
    ...
    case NODE_TYPE_EXPRESSION:
        ...
        case EXPRESSION_UNARY:
            ...
            print_ast_node(node->node_expression.unary_expr.operand,
                           indent + 1);
            break;
        ...
        case EXPRESSION_ASSIGNMENT:
            ...
            print_ast_node(node->node_expression.assignment_expr.left,
                           indent + 1);
            print_ast_node(node->node_expression.assignment_expr.right,
                           indent + 1);
            break;
